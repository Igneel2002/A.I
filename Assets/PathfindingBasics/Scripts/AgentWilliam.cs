...
public class AgentWilliam : MonoBehaviour
{
    private NavMeshAgent agent;
    private Waypoint2[] waypoints;

    private Waypoint2 RandomPoint => waypoints[Random.Range(0, waypoints.Length)];
    ...
    void Start()
    {
        ...
        waypoints = FindObjectsOfType<Waypoint2>();
